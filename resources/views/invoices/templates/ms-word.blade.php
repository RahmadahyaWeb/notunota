<div
    style="width: 210mm; min-height: 297mm; margin: 0 auto; padding: 30mm; font-family: 'Garamond', 'Georgia', serif; color: #1a1a1a; background: #fff; line-height: 1.5;">
            ...
            <td style="width: 50%; vertical-align: top;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="border-top: 2px solid #000; font-size: 16px; font-weight: bold;">
                        <td style="padding: 15px 10px; text-align: right; text-transform: uppercase;">Total Tagihan</td>
