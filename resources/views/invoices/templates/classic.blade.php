<div
    style="width: 210mm; min-height: 297mm; margin: 0 auto; padding: 20mm; font-family: Arial, sans-serif; font-size: 12px; color: #333; box-sizing: border-box; background: #fff;">
    ...
    <div style="margin-bottom: 20px;">
        <div style="text-transform: uppercase; letter-spacing: 1px; color: #888; font-size: 10px; margin-bottom: 5px;">
            Bill To
        </div>
            ...
            <tbody>
                @foreach ($data['items'] as $index => $item)
                    <tr>
                        ...
                        <td style="padding: 12px 8px; text-align: right; {{ $borderStyle }}">{{ $item['qty'] }}</td>
