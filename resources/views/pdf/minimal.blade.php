...
<body>
    <div
        style="margin: 0 auto; padding: 40px; font-family: 'Courier New', Courier, monospace; font-size: 12px; color: #000; background: #fff;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
            <thead>
                <tr style="border-bottom: 2px solid #000;">
                    ...
                    <th style="text-align: right; padding: 10px 5px; width: 120px; text-transform: uppercase;">Unit
                        Price
                    </th>
                    <th style="text-align: right; padding: 10px 5px; width: 120px; text-transform: uppercase;">Amount
                    </th>
                </tr>
            </thead>
            <tbody>
        ...
        <div
            style="margin-top: 100px; font-size: 10px; text-align: center; border-top: 1px solid #eee; padding-top: 10px;">
